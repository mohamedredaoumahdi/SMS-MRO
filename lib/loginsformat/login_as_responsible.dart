...
class LoginAsResponsible extends StatefulWidget{
  LoginAsResponsible({required this.auth});
  final AuthBase auth;
  @override
  _LoginAsResponsibleState createState() => _LoginAsResponsibleState();
}

class _LoginAsResponsibleState extends State<LoginAsResponsible> {
        ...
        children: [
          Padding(
            ...
            child: new Positioned(
              ...
              right: 0.0,
              child: AppBar(
                title: Text(' LOGIN AS RESPONSIBLE ',
