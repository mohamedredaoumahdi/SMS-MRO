...
class SeeClassCoursesPage extends StatefulWidget {
  @override
  _SeeClassCoursesPageState createState() => _SeeClassCoursesPageState();
}

class _SeeClassCoursesPageState extends State<SeeClassCoursesPage> {
          ...
          children: [
            Padding(
              ...
              child: new Positioned(
                ...
                right: 0.0,
                child: AppBar(
                  title: new Text(" WIEW A CLASS COURSES ",
